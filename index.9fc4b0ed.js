...
function(e){let t=`
  ...
  `).join("");c.innerHTML=t}(e)}).catch(e=>console.error("Error fetching data:",e))}(o),u.style.display="none"});const m=document.querySelector(".down-btn"),p=document.querySelector(".up-btn"),h=document.querySelector(".charities__list");m.addEventListener("click",()=>{setTimeout(function(){h.scrollTo(0,1e3)},10),m.classList.add("is-hidden"),p.classList.remove("is-hidden")}),p.addEventListener("click",()=>{setTimeout(function(){h.scrollTo(top)},10),p.classList.add("is-hidden"),m.classList.remove("is-hidden")});const g=new t,k="storage-book-data";let y={};const b=document.querySelector(".pop-up-modal"),f=document.querySelector(".backdrop-modal"),_=document.querySelector("#allBooks"),w=document.querySelector(".category-books-list"),v=document.querySelector(".close-pop-up-modal-btn"),T=document.querySelector(".add-book-button"),L=document.querySelector(".storage-comment"),$=document.querySelector(".remove-button");function S(){b.classList.add("is-hidden"),f.classList.add("is-hidden")}async function z(e){try{y={};let t=await g.fetchById(e),o=await t.json();return y={book_image:o.book_image,title:o.title,author:o.author,description:o.description,marketAmazon:o.buy_links[0].url,marketAppleBooks:o.buy_links[1].url,list_name:o.list_name,id:o._id},o}catch(e){throw console.error("Error",e),e}}async function E(e){_.innerHTML="";try{let t=await z(e);!function(e){let t=e.buy_links[0].url,o=e.buy_links[1].url,s=`
